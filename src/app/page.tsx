          ...
          <div className={'lg:w-[700px]'}>
            ...
            <div className={'w-full h-full flex flex-row justify-end '}>
              ...
              <div
                ...
                <div className="flex flex-row justify-evenly pl- bg-slate-950 rounded-xl w-full h-full text-xl">
                  <div className={'flex flex-col h-full items-center justify-center px-2 gap-y-2 text-slate-500'}>
                    <svg
                      width="85"
                      height="85"
                      className={''}
              ...
              <div
                ...
                <div className="flex flex-col justify-evenly bg-slate-950 rounded-xl w-full h-full pt-10">
                  ...
                  <div className={'w-full flex pr-5 flex-col justify-start items-start gap-2 font-black mt-5'}
                    ...
                    <p className={'text-[0.9rem]'}>
                      بک اند (Django Rest Framework) DRF سویچ و سنسور ها با Esp8266 . روشن یا خاموش کردن سویچ ها و رصد سنسور های هوشمند در خانه.
                      <br/>
